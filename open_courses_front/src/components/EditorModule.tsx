import { CourseWithModules, ModuleWithMaterials, UpdateStatus } from "@/dataclasses/course"
...
const EditorModule = ({ course, index, module, onDelete }: ModuleProps) => {
    ...
    function handleDeleteModule() {
        ...
        module.update_status = UpdateStatus.DELETED;
        onDelete(index);
    }

    if (module.update_status == UpdateStatus.DELETED) return null;
